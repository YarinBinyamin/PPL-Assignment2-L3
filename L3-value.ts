...
// for sub model
export const makeClass = (fields: VarDecl[], methods: Binding[]): Value =>
    ({tag: "Class", fields: fields, methods: methods, env : makeEmptyEnv()}); 
// for env model

export const makeClassEnv = (fields: VarDecl[], methods: Binding[], env: Env): Value =>
...
export const makeObject = (class_: Class, fields: Value[], env: Env ): Value =>
    ({tag: "Object", class: class_, fields: fields, env: env});  
